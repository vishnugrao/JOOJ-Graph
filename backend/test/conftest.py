...
def graph_withnodes_payload():
    return {'SJ': {'name': 'SJ', 'nodes': [{'user_id': 'f1d71d4b-a88c-4170-aa6b-eb8753bc2e89', 'First_name': 'V', 'Last_name': 'Rao', 'Profile_picture_url': '', 'Email': 'VRao@outlook.com'}, 
                                           {'user_id': 'c11fc4fb-266a-4ae3-acdc-49fec05b85d9', 'First_name': 'Jay', 'Last_name': 'Lo', 'Profile_picture_url': '', 'Email': 'JLo@gmail.com'}], 
...
def add_node_response(node_payload):
    # Returns: {'user_id': 'f1d71d4b-a88c-4170-aa6b-eb8753bc2e89', 'First_name': 'V', 'Last_name': 'Rao', 'Profile_picture_url': '', 'Email': 'VRao@outlook.com'}
...
def add_edge_response(edge_payload):
    # Returns {'source': {'user_id': 'f1d71d4b-a88c-4170-aa6b-eb8753bc2e89', 'First_name': 'V', 'Last_name': 'Rao', 'Profile_picture_url': '', 'Email': 'VRao@outlook.com'}, 'target': {'user_id': 'c11fc4fb-266a-4ae3-acdc-49fec05b85d9', 'First_name': 'Jay', 'Last_name': 'Lo', 'Profile_picture_url': '', 'Email': 'JLo@gmail.com'}, 'edge_tag': 'Friend', 'edge_desc': 'From Highschool'}
...
def graph_with_one_node_response(get_graph_response, add_node_response):
    # Returns graph with 1 node fixture response: {'name': 'SJ', 'nodes': [{'user_id': '0ff6e83c-d9d5-42aa-b626-4668c0134757', 'First_name': 'John', 'Last_name': 'Smith', 'Profile_picture_url': '', 'Email': 'Jsmith@gmail.com'}], 'edges': [], 'node_map': {'0ff6e83c-d9d5-42aa-b626-4668c0134757': True}, 'edge_map': {}}
...
@pytest.fixture
def get_node_response(graph_with_one_node_response):
    payload = {"graph_name" : graph_with_one_node_response['name'] , "email" : graph_with_one_node_response['nodes'][0]['Email']}
    response = requests.get(f"{BACKEND_URL}/graph/get/node?graph_name={payload['graph_name']}&email={payload['email']}",  timeout=5)
    if response.status_code != 200: pytest.fail(f"Failed to get node from graph")
    return response.json()

@pytest.fixture
def get_node_response_raw(graph_with_one_node_response):
    payload = {"graph_name" : graph_with_one_node_response['name'] , "email" : graph_with_one_node_response['nodes'][0]['Email']}
    response = requests.get(f"{BACKEND_URL}/graph/get/node?graph_name={payload['graph_name']}&email={payload['email']}",  timeout=5)
    if response.status_code != 200: pytest.fail(f"Failed to get node from graph")
    return response
...
@pytest.fixture
def graph_with_one_edge_response(graph_with_one_node_response):
    # Returns {'name': 'SJ', 'nodes': [{'user_id': 'a9b087a0-5e68-430b-b018-eb7efe2105bd', 'First_name': 'John', 'Last_name': 'Smith', 'Profile_picture_url': '', 'Email': 'Jsmith@gmail.com'}, {'user_id': '455c3749-c067-4860-9829-9d37988fc621', 'First_name': 'Jay', 'Last_name': 'Bart', 'Profile_picture_url': '', 'Email': 'JB@gmail.com'}], 'edges': [{'source': {'user_id': 'a9b087a0-5e68-430b-b018-eb7efe2105bd', 'First_name': 'John', 'Last_name': 'Smith', 'Profile_picture_url': '', 'Email': 'Jsmith@gmail.com'}, 'target': {'user_id': '455c3749-c067-4860-9829-9d37988fc621', 'First_name': 'Jay', 'Last_name': 'Bart', 'Profile_picture_url': '', 'Email': 'JB@gmail.com'}, 'edge_tag': 'Friend', 'edge_desc': 'From Highschool'}], 'node_map': {'455c3749-c067-4860-9829-9d37988fc621': True, 'a9b087a0-5e68-430b-b018-eb7efe2105bd': True}, 'edge_map': {'a9b087a0-5e68-430b-b018-eb7efe2105bd-455c3749-c067-4860-9829-9d37988fc621': True}}
    second_node_payload = {"first_name": "Jay", "last_name": "Bart", "email": "JB@gmail.com"}
    node = requests.post(f"{BACKEND_URL}/create/node", json=second_node_payload, timeout=5).json()

    payload = {"graphname" : graph_with_one_node_response['name'] , "node" : node}
    addedNode = requests.post(f"{BACKEND_URL}/graph/add/node", json=payload,  timeout=5)
    if addedNode.status_code != 201: pytest.fail(f"Failed to add node to the graph")

    graph = requests.get(f"{BACKEND_URL}/get/graph?name={graph_with_one_node_response['name']}",  timeout=5).json()
    ...
    addedEdge = requests.post(f"{BACKEND_URL}/graph/add/edge", json=payload,  timeout=5)
    if addedEdge.status_code != 201: pytest.fail(f"Failed to add edge to the graph")
    
    response = requests.get(f"{BACKEND_URL}/get/graph?name={graph['name']}",  timeout=5)
    return response.json()

@pytest.fixture
def graph_with_one_edge_response_raw(graph_with_one_node_response):
    # Returns {'name': 'SJ', 'nodes': [{'user_id': 'a9b087a0-5e68-430b-b018-eb7efe2105bd', 'First_name': 'John', 'Last_name': 'Smith', 'Profile_picture_url': '', 'Email': 'Jsmith@gmail.com'}, {'user_id': '455c3749-c067-4860-9829-9d37988fc621', 'First_name': 'Jay', 'Last_name': 'Bart', 'Profile_picture_url': '', 'Email': 'JB@gmail.com'}], 'edges': [{'source': {'user_id': 'a9b087a0-5e68-430b-b018-eb7efe2105bd', 'First_name': 'John', 'Last_name': 'Smith', 'Profile_picture_url': '', 'Email': 'Jsmith@gmail.com'}, 'target': {'user_id': '455c3749-c067-4860-9829-9d37988fc621', 'First_name': 'Jay', 'Last_name': 'Bart', 'Profile_picture_url': '', 'Email': 'JB@gmail.com'}, 'edge_tag': 'Friend', 'edge_desc': 'From Highschool'}], 'node_map': {'455c3749-c067-4860-9829-9d37988fc621': True, 'a9b087a0-5e68-430b-b018-eb7efe2105bd': True}, 'edge_map': {'a9b087a0-5e68-430b-b018-eb7efe2105bd-455c3749-c067-4860-9829-9d37988fc621': True}}
    second_node_payload = {"first_name": "Jay", "last_name": "Bart", "email": "JB@gmail.com"}
    node = requests.post(f"{BACKEND_URL}/create/node", json=second_node_payload, timeout=5).json()
    payload = {"graphname" : graph_with_one_node_response['name'] , "node" : node}
