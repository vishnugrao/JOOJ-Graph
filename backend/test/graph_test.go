...
func TestGraphAddMultipleNode(t *testing.T) {
	...
	node2, err := api.CreateUserNode(
		"Jane", "Smith", "Placeholder2", "JaneSmith@email.com")
	...
	node3, err := api.CreateUserNode(
		"Joe", "Jo", "Placeholder3", "JoeJo@email.com")
...
func TestGraphAddEdge(t *testing.T) {
	...
	edge, err := api.CreateUserEdge(John, Jane, "Family", "Desc AB")
...
func TestGraphAddEdgeWithInvalidNode(t *testing.T) {
	...
	edge2, err := api.CreateUserEdge(Jane, Joe, "Friend", "Desc BC")
...
func TestGraphAddMultipleEdge(t *testing.T) {
	...
	edge1, err := api.CreateUserEdge(John, Jane, "Family", "Desc AB")
	if err != nil {
		t.Errorf("Expected no error but got %v", err)
	}

	edge2, err := api.CreateUserEdge(Jane, John, "Family", "Desc BA")
	if err != nil {
		t.Errorf("Expected no error but got %v", err)
	}

	edge3, err := api.CreateUserEdge(John, Joe, "Friend", "Desc AC")
	if err != nil {
		t.Errorf("Expected no error but got %v", err)
	}

	edge4, err := api.CreateUserEdge(Jane, Joe, "Friend", "Desc BC")
...
func TestGraphDuplicateEdgeDetection(t *testing.T) {
	...
	edge1, err := api.CreateUserEdge(John, Joe, "Friend", "Desc AB")
	if err != nil {
		t.Errorf("Expected no error but got %v", err)
	}

	edge2, err := api.CreateUserEdge(Joe, John, "Family", "Desc BA")
	if err != nil {
		t.Errorf("Expected no error but got %v", err)
	}

	edge3, err := api.CreateUserEdge(John, Joe, "Friend", "Desc AB")
	if err != nil {
		t.Errorf("Expected no error but got %v", err)
	}
...
func TestGraphRemoveEdge(t *testing.T) {
	...
	edge1, err := api.CreateUserEdge(John, Jane, "Friend", "Desc AB")
	if err != nil {
		t.Errorf("Expected no error but got %v", err)
	}
	...
	edge3, err := api.CreateUserEdge(Jane, Joe, "Friend", "Desc AC")
	if err != nil {
		t.Errorf("Expected no error but got %v", err)
	}
